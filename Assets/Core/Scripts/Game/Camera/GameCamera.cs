...
public class GameCamera : MonoBehaviour
{
    ...
    void UpdateDepthOfField()
    {
        ...
        if (Physics.Raycast(transform.position, transform.forward, out hit))
        {
            ...
            //Fog
            if (Fog) RenderSettings.fogDensity = Mathf.SmoothDamp(RenderSettings.fogDensity, Mathf.Lerp(World.CurrentWeather.FogMaxDensity, World.CurrentWeather.FogMinDensity, currentDistance / maxDistance), ref FogVelocity, CameraFogSmoothness);
        }
    }
}
